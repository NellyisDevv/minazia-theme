...
function et_divi_replace_parent_stylesheet() {
	$should_use_dynamic_css = et_enable_dynamic_css_theme();
	$theme_version          = et_get_theme_version();
	$post_id                = get_the_ID();
...
function et_enqueue_theme_scripts_full_screen_menu() {
	...
	if ( et_disable_js_on_demand_theme() || is_customize_preview() || 'fullscreen' === et_get_option( 'header_style', 'left' ) && ! et_is_theme_builder_header_used() ) {
 ...
 * @since ??
 */
function et_enable_dynamic_css_theme() {
	// TODO feat(D5, To be revisited) Remove this or deprecate the function during Divi 5 test.
	// We are temporarily returning false to force Dynamic Assets to be on to improve performance.
	if ( ! et_core_is_fb_enabled() && ! is_preview() && ! is_customize_preview() ) {
		return true;
	}

	static $et_enable_dynamic_css_theme = null;

	if ( null === $et_enable_dynamic_css_theme ) {
		$et_enable_dynamic_css_theme = \ET\Builder\FrontEnd\Assets\DynamicAssetsUtils::use_dynamic_assets();

		/**
		 * Filters whether to enable Dynamic CSS for theme styles.
		 *
		 * @since ??
		 *
		 * @param bool $et_enable_dynamic_css_theme
		 */
		$et_enable_dynamic_css_theme = apply_filters( 'et_enable_dynamic_css_theme', (bool) $et_enable_dynamic_css_theme );
	}

	return $et_enable_dynamic_css_theme;
}
...
function et_divi_get_disallowed_plugins() {
	return [
		'divi-ajax-filter/divi-ajax-filter.php',
		'divi-bodycommerce/divi-bodyshop-woocommerce.php',
		'divi-form-builder/divi-form-builder.php',
		'divi-machine/divi-machine.php',
		'divi-machine-account/divi-machine-account.php',
		'divi-mega-menu/divi-mega-menu.php',
		'divi-membership/divi-membership.php',
		'divi-mobile/divi-mobile.php',
		'divi-nitro/divi-nitro.php',
		'divi-protect/divi-protect.php',
		'divi-modules-image-box/divi-modules-image-box.php',
		'divi-modules-simple-heading/divi-modules-simple-heading.php',
		'divi-modules-table-maker/divi-modules-table-maker.php',
		'divi-modules-tablepress-styler/divi-modules-tablepress-styler.php',
		'divi-modules-text-on-a-path/divi-modules-text-on-a-path.php',
		'divi-modules-typewriter/divi-modules-typewriter.php',
		'chi-divi-accordions/chi-divi-accordions.php',
		'divi-mad-menu/divi-mad-menu.php',
	];
}
