...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', '5.0.0-public-alpha.3' );
}
...
function et_fb_current_page_params() {
	...
	$current_page = array(
		...
		// TODO, temporary solution to get the current page layout to load on woo single product page.
		// see https://github.com/elegantthemes/Divi/issues/39256
		// the below are D4 paradigm, we need to refactor this to D5 paradigm.
