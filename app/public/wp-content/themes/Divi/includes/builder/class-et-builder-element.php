...
class ET_Builder_Element {
	...
	public function __construct() {
		...
		// TODO feat(D5, Optimization) Maybe only collect module definition of module that has no D5 support yet.
		if ( et_builder_d5_enabled() ) {
			self::$_shortcode_module_definitions[ $this->slug ] = array(
				...
				'settings'   => array(
					'group' => $this->settings_modal_toggles,
				),
				'render'     => array(
