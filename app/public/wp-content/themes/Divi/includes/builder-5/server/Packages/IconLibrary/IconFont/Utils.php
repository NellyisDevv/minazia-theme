...
class Utils {
	 ...
	 * {@link /docs/builder-api/js/icon-library/find-icon-in-list findIconInList}
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/icon-library/is-fa-icon isFaIcon}
	 * in `@divi/icon-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/icon-library/process-font-icon processFontIcon}
	 * in `@divi/icon-library` package.
	 *
	 * @since ??
	 *
