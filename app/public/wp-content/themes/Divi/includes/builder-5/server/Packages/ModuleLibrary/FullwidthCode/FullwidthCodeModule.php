...
class FullwidthCodeModule implements DependencyInterface {
	...
	/**
	 * Style declaration for fullwidth code's border.
	 *
	 * This function is used to generate the style declaration for the border of a fullwidth code module.
	 *
	 * @since ??
	 *
	...
	public function load(): void {
		...
		add_filter( 'divi_conversion_presets_attrs_map', array( FullwidthCodePresetAttrsMap::class, 'get_map' ), 10, 2 );
