...
class Conditions {
	...
	use ConditionsTraits\IsVBEnabledTrait;
	 ...
	 *
	 * If this function is called with `content=null`, and the current query is for an existing single post of any post type (`is_singular=true`),
	 * then the function will attempt to get the raw post content via `get_post_field` using `get_the_ID` to get the post ID.
	 *
