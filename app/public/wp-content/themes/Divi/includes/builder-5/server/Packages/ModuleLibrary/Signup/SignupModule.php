...
class SignupModule implements DependencyInterface {
	...
	public static function module_classnames( $args ) {
		...
		$layout = $attrs['module']['advanced']['layout']['desktop']['value'] ?? '';
		if ( ! empty( $layout ) ) {
			$classnames_instance->add( 'et_pb_newsletter_layout_' . $layout, true );
		}
	 ...
	 * @param string         $children                    The block's custom fields.
	 ...
	 */
	public static function render_callback( array $attrs, string $children, WP_Block $block, ModuleElements $elements, array $default_printed_style_attrs ) {
		...
		$footer_content_wrapper = HTMLUtility::render(
			[
				'tag'               => 'div',
				'tagEscaped'        => true,
				'attributes'        => [
		...
		$success_message_text = $attrs['success']['advanced']['message']['desktop']['value'] ?? __( 'Success!', 'et_builder' );
		...
		$form_fields_wrapper = HTMLUtility::render(
			[
				...
				'tagEscaped'        => true,
				'attributes'        => [
					'class' => 'et_pb_newsletter_fields',
				],
				'childrenSanitizer' => 'et_core_esc_previously',
				'children'          => [
					$show_provider_name_field_only && 'on' === $name_field_only ? self::render_field( $attrs, 'name', true ) : '',
					$show_provider_first_name_field && ( 'on' === $first_name_field || 'on' === $name_field ) ? self::render_field( $attrs, 'name', 'on' === $name_field ) : '',
					$show_provider_last_name_field && 'on' === $last_name_field && 'on' !== $name_field ? self::render_field( $attrs, 'last_name' ) : '',
					self::render_field( $attrs, 'email' ),
					'on' === $use_custom_fields && $is_render_custom_fields ? $children : '',
					$button_html_wrapper,
					self::render_field( $attrs, 'hidden' ),
				],
			]
		);

		// Email Optin form fields.
		$has_custom_fields = $attrs['customFields']['advanced']['enable']['desktop']['value'] ?? 'off';
		$form_fields       = HTMLUtility::render(
			[
				...
				'attributes'        => [
					'class'  => HTMLUtility::classnames(
						[
							'et_pb_newsletter_custom_fields' => 'on' === $has_custom_fields,
						]
					),
					'method' => 'post',
				],
		...
		$form = $is_render_form ? HTMLUtility::render(
			[
				'tag'               => 'div',
				'tagEscaped'        => true,
				'attributes'        => [
	 ...
	 * @return string
	 */
	public static function render_field( array $attrs, string $field_type, bool $name_field_only = false ): string {
		$html = '';
		...
		switch ( $field_type ) {
			case 'name':
				...
				$fullwidth_firstname     = $attrs['field']['advanced']['firstNameFullwidth']['desktop']['value'] ?? 'on';
				$has_name_fullwidth      = 'on' === $fullwidth_name;
				$has_firstname_fullwidth = 'on' === $fullwidth_firstname;
				$fullwidth               = $name_field_only ? $has_name_fullwidth : $has_firstname_fullwidth;
				$label                   = $name_field_only ? __( 'Name', 'et_builder' ) : __( 'First Name', 'et_builder' );
						...
						'attributes'        => [
							'class' => HTMLUtility::classnames(
								[
									...
									'et_pb_contact_field_last'        => $fullwidth,
									'et_pb_contact_field_half'        => ! $fullwidth,
									'et_pb_contact_field_last_tablet' => false,
									'et_pb_contact_field_half_tablet' => false,
									'et_pb_contact_field_last_phone'  => false,
									'et_pb_contact_field_half_phone'  => false,
								]
							),
						],
						'childrenSanitizer' => 'et_core_esc_previously',
			...
			case 'last_name':
				$fullwidth_lastname     = $attrs['field']['advanced']['lastNameFullwidth']['desktop']['value'] ?? 'on';
				$has_lastname_fullwidth = 'on' === $fullwidth_lastname;
					...
					[
						...
						'attributes'        => [
							'class' => HTMLUtility::classnames(
								[
									'et_pb_newsletter_field'          => true,
									'et_pb_contact_field_last'        => $has_lastname_fullwidth,
									'et_pb_contact_field_half'        => ! $has_lastname_fullwidth,
									'et_pb_contact_field_last_tablet' => false,
									'et_pb_contact_field_half_tablet' => false,
									'et_pb_contact_field_last_phone'  => false,
									'et_pb_contact_field_half_phone'  => false,
			...
			case 'email':
				...
				$has_email_fullwidth = 'on' === $fullwidth_email;
					...
					[
						...
						'attributes'        => [
							'class' => HTMLUtility::classnames(
								[
									'et_pb_newsletter_field'          => true,
									'et_pb_contact_field_last'        => $has_email_fullwidth,
									'et_pb_contact_field_half'        => ! $has_email_fullwidth,
									'et_pb_contact_field_last_tablet' => false,
									'et_pb_contact_field_half_tablet' => false,
									'et_pb_contact_field_last_phone'  => false,
									'et_pb_contact_field_half_phone'  => false,
