...
class StyleDeclarations {
	 ...
	 * {@link /docs/builder-api/js/module/spacing-icon-style-declaration spacingIconStyleDeclaration} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function spacing_icon_style_declaration( array $args ): string {
		...
		$placement = $args['attrValue']['icon']['placement'] ?? null;
		$on_hover  = $args['attrValue']['icon']['onHover'] ?? null;
		$enable    = $args['attrValue']['icon']['enable'] ?? null;
		$padding   = $args['attrValue']['padding'] ?? [];
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/spacing-icon-hover-style-declaration spacingIconHoverStyleDeclaration} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
