...
class OverflowStyle {
	 ...
	 * {@link /docs/builder-api/js/module/overflow-style OverflowStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function style( array $args ) {
		...
		$children = Utils::get_statements(
			[
				...
				'important'               => $important,
				'declarationFunction'     => '\ET\Builder\Packages\StyleLibrary\Declarations\Overflow\Overflow::style_declaration',
