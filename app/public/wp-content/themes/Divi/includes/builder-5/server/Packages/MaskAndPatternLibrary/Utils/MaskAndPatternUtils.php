...
class MaskAndPatternUtils {
	 ...
	 * {@link /docs/builder-api/js/mask-and-pattern-library/encode-svg-for-data-uri encodeSvgForDataURI}
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-mask-default-viewbox-settings getMaskDefaultViewboxSettings}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-mask-json getMaskJson}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-mask-settings getMaskSettings}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-mask-style-options getMaskStyleOptions}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-mask-svg getMaskSvg}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-pattern-default-thumbnail-settings getPatternDefaultThumbnailSettings}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-pattern-json getPatternJSON}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-pattern-settings getPatternSettings}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-pattern-style-options getPatternStyleOptions}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-pattern-svg getPatternSvg}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/mask-and-pattern-library/get-svg-attrs getSvgAttrs}
	 * in `@divi/mask-and-pattern-library` package.
	 *
	 * @since ??
	 *
