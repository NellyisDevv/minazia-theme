...
class FullwidthPostSliderModule implements DependencyInterface {
	...
	/**
	 * Style declaration for fullwidth post slider's border.
	 *
	 * This function is used to generate the style declaration for the border of a fullwidth post slider module.
	 *
	 * @since ??
	 *
	...
	public function load() {
		...
		add_filter( 'divi_conversion_presets_attrs_map', array( FullwidthPostSliderPresetAttrsMap::class, 'get_map' ), 10, 2 );
