...
class TextShadowStyle {
	 ...
	 * {@link /docs/builder-api/js/module/text-shadow-style TextShadowStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function style( array $args ) {
		...
		$children = Utils::get_statements(
			[
				...
				'attr'                 => $attr,
				'important'            => $important,
				'declarationFunction'  => '\ET\Builder\Packages\StyleLibrary\Declarations\TextShadow\TextShadow::style_declaration',
