...
class BackgroundComponentParallax {
	 ...
	 * {@link /docs/builder-api/js/module/background-component-parallax-container BackgroundComponentParallaxContainer} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function container( array $args ): string {
		...
		if ( $background_attr && isset( $background_attr['desktop']['sticky'] ) ) {
			...
			$enable['sticky'] = StickyUtils::is_sticky_module( $module_id, $module_objects ) || StickyUtils::is_inside_sticky_module( $module_id, $module_objects );
		}
