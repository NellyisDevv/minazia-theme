...
class BackgroundComponentPattern {
	 ...
	 * {@link /docs/builder-api/js/module/background-component-pattern BackgroundComponentPattern} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/background-component-pattern-container BackgroundComponentPatternContainer} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
