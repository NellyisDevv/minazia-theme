...
class DividerUtils {
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/divider-library/get-divider-default-viewbox-settings getDividerDefaultViewboxSettings}
	 * in `@divi/divider-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/divider-library/get-divider-json getDividerJson}
	 * in `@divi/divider-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/divider-library/get-divider-settings getDividerSettings}
	 * in `@divi/divider-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/divider-library/get-divider-style-options getDividerStyleOptions}
	 * in `@divi/divider-library` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/divider-library/get-divider-svg getDividerSvg}
	 * in `@divi/divider-library` package.
	 *
	 * @since ??
	 *
	...
	public static function get_divider_svg( array $divider_svg_params ): string {
		...
		$height    = $divider_svg_params['height'];
		...
		$props_settings = [
			...
			'height'              => $svg_height ?? $height ?? $default_height,
