...
class FontStyle {
	 ...
	 * {@link /docs/builder-api/js/module/font-style FontStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
		...
		if ( ! empty( $attr_font ) ) {
			...
			$children_statements = Utils::get_statements(
				[
					...
					'declarationFunction'     => '\ET\Builder\Packages\StyleLibrary\Declarations\Font\Font::style_declaration',
					'attr'                    => $attr['font'] ?? [],
