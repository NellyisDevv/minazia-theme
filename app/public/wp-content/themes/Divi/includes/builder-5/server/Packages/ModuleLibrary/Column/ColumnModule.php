...
class ColumnModule implements DependencyInterface {
	 ...
	 * {@link /docs/builder-api/js/module-library/generate-default-attrs getColumnInnerType}
	...
	public function load(): void {
		...
		add_filter( 'divi_conversion_presets_attrs_map', array( ColumnPresetAttrsMap::class, 'get_map' ), 10, 2 );
