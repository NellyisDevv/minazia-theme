...
class ButtonIconStyle {
	 ...
	 * {@link /docs/builder-api/js/module/button-icon-style ButtonIconStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function icon_style( array $args ) {
		...
		$children_statements = Utils::get_statements(
			[
				...
				'selectorFunction'    => function( $params ) {
					...
					$main_placement    = isset( $attr['desktop']['value']['icon']['placement'] ) ? $attr['desktop']['value']['icon']['placement'] : $default_placement;
					$current_placement = $is_main
						? $main_placement
						: (
							isset( $attr[ $breakpoint ][ $state ]['icon']['placement'] )
		...
		$children_hover = Utils::get_statements(
			[
				'selectors'           => $icon_selectors,
				'propertySelectors'   => $property_selectors,
				'attr'                => $attr,
		...
		$children_right = Utils::get_statements(
			[
				'selectors'           => $icon_selectors,
				'propertySelectors'   => $property_selectors,
				'attr'                => $attr,
		...
		$children_disable = Utils::get_statements(
			[
				'selectors'           => $icon_selectors,
				'propertySelectors'   => $property_selectors,
				'attr'                => $attr,
