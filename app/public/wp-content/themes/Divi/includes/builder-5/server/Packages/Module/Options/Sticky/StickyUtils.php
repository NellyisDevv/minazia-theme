...
class StickyUtils {
	...
	public static function is_inside_sticky_module( string $id, array $layout_state ): bool {
		...
		foreach ( $ancestors as $ancestor ) {
			$module_attrs = $layout_state[ $ancestor ]->attrs ?? [];
	 ...
	 * ```
	 */
	public static function is_sticky_module( string $id, array $layout_state ): bool {
		// No nested sticky element.
		if ( self::is_inside_sticky_module( $id, $layout_state ) ) {
			return false;
		}
