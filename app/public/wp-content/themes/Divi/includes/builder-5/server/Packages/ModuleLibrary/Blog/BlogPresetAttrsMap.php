...
class BlogPresetAttrsMap {
	...
	public static function get_map( array $map, string $module_name ) {
		...
		return [
			...
			'image.decoration.filter__hueRotate'           => [
			...
			'image.decoration.filter__saturate'            => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__brightness'          => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__contrast'            => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__invert'              => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__sepia'               => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__opacity'             => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
			...
			'image.decoration.filter__blendMode'           => [
				'attrName' => 'image.decoration.filter',
				'preset'   => [
					'style',
				],
