...
class Module implements DependencyInterface {
	...
	public static function get_rendered_content( $args = [] ): string {
		...
		// TODO fix(D5, Shortcode Module), lets test and see if et_load_shortcode_framework() is needed to be called here.
		// Most likely, the shortcode manager itself will kick off the shortcode framework.
