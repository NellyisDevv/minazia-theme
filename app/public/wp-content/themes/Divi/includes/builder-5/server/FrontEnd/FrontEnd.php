...
class FrontEnd {
	 ...
	 * @return void
	 *
	 * @example: Load and initialize the Frontend
	 * ```php
	 * loadFrontEnd();
	 * ```
	 */
	 ...
	 * @example
	 * ```php
	 * $theme = new MyTheme\Theme();
	 * $theme->register_fe_styles();
	 * ```
	 */
	 ...
	 * @example
	 * ```php
	 * $scripts = get_frontend_scripts();
	 * // Output: ['script1', 'script2', 'script3']
	 * ```
	 *
	 * @example
	 * ```php
	 ...
	 * @return void
	 *
	 * @example: This will register the front-end scripts for the current theme.
	 * ```php
	 * register_fe_scripts();
	 * ```
	 *
	 * @example: This will register the front-end scripts for the `Custom_Theme` class.
	 * ```php
	 * $custom_theme = new Custom_Theme();
	 * $custom_theme->register_fe_scripts();
	 * ```
	 */
	 ...
	 * @example
	 * ```php
	 * override_d4_fe_scripts();
	 * ```
	 */
	public function override_d4_fe_scripts(): void {
		...
		if ( $is_fe_or_vb_app_window ) {
			// register et_get_combined_script_handle's deps.
	 ...
	 * @return void
	 *
	 * @example: Enqueue script data in the footer
	 * ```php
	 * enqueue_script_at_footer();
	 * ```
	 */
	 ...
	 * ```php
	 * enqueue_fonts_in_footer(); // Enqueues fonts in the footer
	 * ```
	 */
