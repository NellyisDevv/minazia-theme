...
class BackgroundStyle {
	 ...
	 * {@link /docs/builder-api/js/module/background-style BackgroundStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function style( array $args ) {
		...
		$children_background = $has_background ? Utils::get_statements(
			[
		...
		$children_background = $has_mask ? Utils::get_statements(
			[
		...
		$children_background = $has_pattern ? Utils::get_statements(
			[
