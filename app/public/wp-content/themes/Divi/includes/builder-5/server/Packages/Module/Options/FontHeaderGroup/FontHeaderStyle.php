...
class FontHeaderStyle {
	 ...
	 * {@link /docs/builder-api/js/module/font-header-style/ FontHeaderStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
				...
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h1';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h1';
						}
		...
		if ( ! empty( $attr['h2'] ) ) {
			$children_h2 = FontStyle::style(
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h2';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h2';
						}
		...
		if ( ! empty( $attr['h3'] ) ) {
			$children_h3 = FontStyle::style(
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h3';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h3';
						}
		...
		if ( ! empty( $attr['h4'] ) ) {
			$children_h4 = FontStyle::style(
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h4';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h4';
						}
		...
		if ( ! empty( $attr['h5'] ) ) {
			$children_h5 = FontStyle::style(
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h5';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h5';
						}
		...
		if ( ! empty( $attr['h6'] ) ) {
			$children_h6 = FontStyle::style(
				[
					...
					'selectorFunction'        => function( $params ) use ( $selector_function ) {
						if ( $selector_function ) {
							return call_user_func( $selector_function, $params ) . ' h6';
						}

						if ( isset( $params['selector'] ) ) {
							return $params['selector'] . ' h6';
						}
