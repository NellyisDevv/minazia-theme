...
class SizingStyle {
	 ...
	 * {@link /docs/builder-api/js/module/sizing-style SizingStyle} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function style( array $args ) {
		...
		$children = Utils::get_statements(
			[
				...
				'important'               => $important,
				'declarationFunction'     => '\ET\Builder\Packages\StyleLibrary\Declarations\Sizing\Sizing::style_declaration',
