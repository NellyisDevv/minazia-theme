...
class ButtonIcon {
	...
	public static function style_declaration( array $args ) {
		...
		$enable           = isset( $attr_value['icon']['enable'] ) ? $attr_value['icon']['enable'] : null;
		$settings         = isset( $attr_value['icon']['settings'] ) ? $attr_value['icon']['settings'] : [];
		$color            = isset( $attr_value['icon']['color'] ) ? $attr_value['icon']['color'] : null;
		$on_hover         = isset( $attr_value['icon']['onHover'] ) ? $attr_value['icon']['onHover'] : null;
		$placement        = isset( $attr_value['icon']['placement'] ) ? $attr_value['icon']['placement'] : null;
		$always_important = [
			'font-family' => true,
			'font-weight' => true,
	...
	public static function hover_style_declaration( array $args ) {
		...
		$return_type = $args['returnType'];
		$enable      = isset( $attr_value['icon']['enable'] ) ? $attr_value['icon']['enable'] : null;
		$placement   = isset( $attr_value['icon']['placement'] ) ? $attr_value['icon']['placement'] : 'right';
		$important   = $args['important'];
