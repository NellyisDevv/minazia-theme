...
class ElementStyleAdvancedStyles {
	 ...
	 * {@link /docs/builder-api/js/module/element-style/advanced-styles/utils/get-style-components getStyleComponents} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/element-style/advanced-styles/utils/style-component-map styleComponentMap} in
	 * `@divi/module` package.
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/element-style/advanced-styles AdvancedStyles} in
	 * `@divi/module` package.
	 *
	 * @since ??
	 *
