...
class Utils {
	...
	public static function generate_sticky_state_selector(
		...
		foreach ( $maybe_has_multiple_selectors as $selector ) {
			if ( $is_inside_sticky_module ) {
				...
				// to the sticky styles won't be triggered anyway. We should add it followed by
				// single space instead to catch parent/ancestor module with sticky enabled.
				...
				$order_class_regex = '/(?<=\\s|^|>)' . $order_class . '(?=\\s|$|:|\\.|>)/';
	 ...
	 * {@link /docs/builder-api/js/module/get-at-rules getAtRules}
	 ...
	 */
	public static function get_at_rules( string $breakpoint ) {
		$rules = [
			'desktopAbove' => '@media only screen and (min-width: 981px)',
			'tablet'       => '@media only screen and (max-width: 980px)',
			'tabletOnly'   => '@media only screen and (min-width: 768px) and (max-width: 980px)',
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-current-important getCurrentImportant}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function get_current_important( array $args ) {
		...
		return ModuleUtils::get_attr_value(
			[
				'attr'         => $important,
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-current-property-selector-names getCurrentPropertySelectorNames}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	...
	public static function get_current_property_selector_names( array $args ): array {
		...
		$property_selector = ModuleUtils::get_attr_value(
			[
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-expanded-shorthand-important getExpandedShorthandImportant}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-ruleset getRuleset}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-selector-of-property-selectors getSelectorOfPropertySelectors}
	 * in `@divi/module` package.
	 *
	 * @param array $args {
	 *     An array of arguments.
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-selector getSelector}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/get-statement getStatement}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/group-declarations-by-property-selector-names groupDeclarationsByPropertySelectorNames}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/style-wrapper StyleWrapper}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
	 ...
	 *
	 * This function is equivalent of JS function:
	 * {@link /docs/builder-api/js/module/unpack-property-selectors-shorthand-map unpackPropertySelectorsShorthandMap}
	 * in `@divi/module` package.
	 *
	 * @since ??
	 *
